...
function actualizarTarjetasPerfil(contexto) {
  ...
  const hr2m = numeroSeguro(perfil.hourly.relative_humidity_2m?.[indice]);
  const td = numeroSeguro(perfil.hourly.dew_point_2m?.[indice]) ?? (t != null && hr2m != null ? calcularPuntoRocio(t, hr2m) : null);
